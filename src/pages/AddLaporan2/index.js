...
export default function ({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        setTimeout(() => {
            ...
            axios.post(urlAPI + 'v1_add_aktifitas.php', kirim).then(res => {
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView style={{
                ...
                <MyGap jarak={10} />
                <MyInput icon={false} label="Material" onChangeText={x => setKirim({
                    ...kirim,
                    material: x
                })} />
                <MyGap jarak={10} />
                <MyInput icon={false} label="Activity" onChangeText={x => setKirim({
                    ...kirim,
                    activity: x
                })} />
                <MyGap jarak={20} />
